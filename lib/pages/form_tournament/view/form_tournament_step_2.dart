  ...
  return FormBlocStep(
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            TextFieldForm(textFieldBloc: tournamentFormBloc.nameTournament, hintText: 'NOM DU TOURNOIS',textInputAction: TextInputAction.next),
            espaceEntreChamp,
            TextFieldForm(textFieldBloc: tournamentFormBloc.gameNumber, textInputType: TextInputType.number,hintText: 'NOMBRE DE GAME(S)',textInputAction: TextInputAction.next),
            espaceEntreChamp,
            ...
            espaceEntreChamp,
            TextFieldForm(textFieldBloc: tournamentFormBloc.numberTeam, hintText: "NOMBRE D'EQUIPES",textInputType: TextInputType.number,textInputAction: TextInputAction.done),
            espaceEntreChamp,
